...
class OverworldBiomeProvider {
  constructor (mcData, worldSeed) {
    ...
    this.river = new layers.ScaleLayer(mcData, worldSeed, 1000n, layers.ScaleLayer.NORMAL, this.river)
    this.river = new layers.ScaleLayer(mcData, worldSeed, 1001n, layers.ScaleLayer.NORMAL, this.river)
    this.river = new layers.ScaleLayer(mcData, worldSeed, 1002n, layers.ScaleLayer.NORMAL, this.river)
    this.river = new layers.ScaleLayer(mcData, worldSeed, 1003n, layers.ScaleLayer.NORMAL, this.river)
    ...
    if (mcData.isNewerOrEqualTo('1.13')) {
      ...
      this.ocean = new layers.ScaleLayer(mcData, worldSeed, 2001n, layers.ScaleLayer.NORMAL, this.ocean)
      this.ocean = new layers.ScaleLayer(mcData, worldSeed, 2002n, layers.ScaleLayer.NORMAL, this.ocean)
      this.ocean = new layers.ScaleLayer(mcData, worldSeed, 2003n, layers.ScaleLayer.NORMAL, this.ocean)
      this.ocean = new layers.ScaleLayer(mcData, worldSeed, 2004n, layers.ScaleLayer.NORMAL, this.ocean)
      this.ocean = new layers.ScaleLayer(mcData, worldSeed, 2005n, layers.ScaleLayer.NORMAL, this.ocean)
      this.ocean = new layers.ScaleLayer(mcData, worldSeed, 2006n, layers.ScaleLayer.NORMAL, this.ocean)
